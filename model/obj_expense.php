...
class ObjExpense extends ObjectDbInteract
{
	...
	{
		$query = 'SELECT id, shop_id, date, description, bs, sus 
				FROM '.self::DB_TABLE.
				" WHERE id = $item_id";
	...
	// Save the expense item into the database
	public function save()
	{
		...
		if($this->is_new)
			$query = 'INSERT INTO '.self::DB_TABLE." (shop_id, date, description, bs, sus) 
					VALUES ('$this->shop_id', '$this->date', '$this->description', '$this->bs', '$this->sus')";
		else
